...
public:
	...
	void segmenLayersIntoHexagonalSubareasWithBoundryOffset(TriMesh &mesh, TriMesh::Slicing &slice_of_mesh_);//only offseted outer contour 5.2.2017
...
public:
	...
	std::vector<Paths> layer_contours_without_outer_contours;//6.22.2017
	std::vector<Paths> volume_offset_layers_integer;//6.22.2017
