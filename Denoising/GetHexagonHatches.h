...
public:
	...
	//triangular hatches for hexagonal subsectors 5,18,2017
	void get0ParallelLinesForTriangularHatches(TriMesh::Slicing &slice_of_mesh_, int &scale);//5.18.2017
	void get60ParallelLinesForTriangularHatches(TriMesh::Slicing &slice_of_mesh_, int &scale);//5.18.2017
	void get120ParallelLinesForTriangularHatches(TriMesh::Slicing &slice_of_mesh_, int &scale);//5.18.2017
	void getHexagoHatchesWithTriangularHatches(TriMesh &mesh);//5.18.2017
public:
	...
	std::vector<Paths> _0_parallel_lines_for_triangular_hatches;//add 5.18.2017
	std::vector<Paths> _60_parallel_lines_for_triangular_hatches;//add 5.18.2017
	std::vector<Paths> _120_parallel_lines_for_triangular_hatches;//add 5.18.2017
